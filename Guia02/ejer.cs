...
namespace PROGRA1
{
    class EJERCICIOS
    {
        ...
        public void ejercicio11()
        {
            ...
            Console.WriteLine("Su sueldo total es de: " + Sal1);

            SalDis = Sal1 - (Sal1 * 0.25);

            Console.WriteLine("Su sueldo total  con descuento del 10 y 15% es de : " + SalDis);
        ...
        {
            Console.Clear();
            Console.WriteLine(" Programa que realiza la carga del lado de un cuadrado \n mostrar por pantalla el perímetro del mismo");
        ...
        {
            Console.Clear();
            Console.WriteLine("Programa en el cual se ingresen dos numeros y que realice las siguientes operaciones");
            Console.WriteLine(" A) Si los numeros son iguales restarlos \n B) Si los numeros son diferentes sumarlos");
            ...
            if (Val1 == Val2)
            {
                ...
                Console.WriteLine("El numero " + Val1 + " y el " + Val2 + " son iguales , la resta de los numeros es de :" + Resu1);
            }
            ...
            else
            {
                ...
                Resu2 = (Val1 + Val2);
                Console.WriteLine("El numero " + Val1 + " y el " + Val2 + " son diferentes, la suma de los numeros es de :" + Resu2);
            }
